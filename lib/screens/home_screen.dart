    ...
    return Scaffold(
                ...
                for (int index = 0; index < _groceries.length; index++)
                  Padding(
                    ...
                    child: CategoryCard(
                      ...
                      backgroundColor: _categoryCardColors[
                        index % _categoryCardColors.length
                      ],
                    ),
                  ),
              ],
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(padding: EdgeInsets.only(right: index == _meat.length -1 ? 0 : 16,
                ),
      ...
      bottomNavigationBar:  BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(icon: ImageIcon(Svg(_menus[index].icon)),
